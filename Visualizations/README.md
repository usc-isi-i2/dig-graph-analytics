...
Force-directed folder has the code which shows a force directed layout using D3. You can try it out. Force-Directed-New has the code which allows to search for a seller URI and shows the visualization only for that seller URI.
